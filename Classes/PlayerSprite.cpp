...
void CPlayerSprite::onTouchesBegan(cocos2d::CCSet *pTouches, cocos2d::CCEvent *pEvent)
{
	CCTouch* touch = (CCTouch*)(* pTouches->begin());
	m_PosBack = touch->getLocation();
}

void CPlayerSprite::onTouchesMoved(CCSet *pTouches, CCEvent *pEvent)
{
	CCTouch* touch = (CCTouch*)(* pTouches->begin());
...
void CPlayerSprite::MissileExplore(CCNode *pSender)
{
	...
	Vector<CCSpriteFrame* > pAnimFrames;
	char str[64] = {0};
	for (int i = 1; i < 13; i++)
	{
